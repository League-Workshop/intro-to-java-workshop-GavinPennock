...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if (mouseColor==backgroundcolor) {
		...
		if (mouseColor==endcolor) {
			JOptionPane.showMessageDialog(null," you win this was tottally the hardest maze ever, am i right? please try the maze again and complete it a diffrent way which you probably can't do you stoopid nub.");
		}
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("235968__tommccann__explosion-01.wav"));
